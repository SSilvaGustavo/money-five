  ...
  return (
    <div className="flex flex-col justify-center items-center gap-8">
      ...
      <div className="flex items-center gap-4 text-primary-100">
        <TextStyle.Heading
          title="Demais Noticias"
          className="!text-primary-100 max-sm:text-3xl"
        />
        <FaSquareFull />
      </div>
      <SubNews
      ...
      />
      <div
        className="flex items-center gap-2 cursor-pointer text-primary-100 font-bold hover:scale-105 transition-all"

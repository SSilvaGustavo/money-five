...
export default function SubNews({
  ...
  return (
    <div
      className={`flex max-lg:flex-col justify-around items-center rounded-lg w-[80%] lg:w-[60%] py-4 cursor-pointer shadow-black hover:shadow-xl hover:scale-105 transition-all duration-300 ${
        rtl && "flex-row-reverse"
      } ${className}`}
    >
      <Image alt={title} src={image} width={320} className="rounded-lg" />
      <div className="lg:w-1/2 max-lg:mt-4">
